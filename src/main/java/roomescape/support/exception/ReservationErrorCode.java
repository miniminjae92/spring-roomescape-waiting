...
public enum ReservationErrorCode implements ErrorCode {
    ...
    INVALID_RESERVATION_SLOT(HttpStatus.BAD_REQUEST,
        "예약 회차 정보가 유효하지 않습니다.", "예약 날짜, 시간, 테마, 가격과 상태를 확인하십시오."),
    RESERVATION_SLOT_NOT_FOUND(HttpStatus.NOT_FOUND,
        "예약 가능한 운영 회차를 찾을 수 없습니다.", "관리자가 해당 날짜·시간·테마 회차를 생성했는지 확인하십시오."),
    RESERVATION_SLOT_DUPLICATED(HttpStatus.CONFLICT,
        "동일한 날짜·시간·테마의 운영 회차가 이미 존재합니다.", "기존 운영 회차를 사용하십시오."),
